...
class TestUserInteractor:
    ...
    async def test_get_user_found(
        self, user_interactor, mock_user_gateway, mock_uow_user
    ):
    ...
    async def test_get_user_by_username_not_found(
        self, user_interactor, mock_user_gateway
    ):
    ...
    async def test_get_user_by_email_not_found(
        ...
        assert result is None
        mock_user_gateway.get_by_email.assert_called_once_with(
    ...
    @pytest.mark.asyncio
    async def test_get_users_with_params(
        self, user_interactor, mock_user_gateway, mock_uow_user
    ):
        mock_user_gateway.get_all.return_value = [mock_uow_user]
